...
<div class="tabs">
    <a href="a" class="btn btn-default" type="button">Призывникам</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($lead['status'] == 4) { ?>
                                    Оплачено
                                <? } else { ?>
                                    <select class="form-control" id-lead="<?= $lead['id'] ?>" name="status-lead" id="status-lead">
                                        <option <?= $lead['status'] == 1 ? "selected " : '' ?>value="1">Новый</option>
                                        <option <?= $lead['status'] == 2 ? "selected " : '' ?>value="2">Сделка</option>
                                        <option <?= $lead['status'] == 3 ? "selected " : '' ?>value="3">Консультация</option>
                                    </select>
                                <? } ?>
                            </td>
                            <td>
                                <button  id-lead="<?= $lead['id'] ?>" class="btn btn-default clouseLead" type="button">Закрыть лид</button>
                            </td>
                        </tr>
                <?php
                    }
